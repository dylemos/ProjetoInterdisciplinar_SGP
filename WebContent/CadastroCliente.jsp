    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
			<div class="6u 12u$(mobile)"><input type="text" name="name" placeholder="Código" /></div>
				...
				<div class="6u$ 12u$(mobile)"><input type="number" name="cpf" placeholder="CPF" /></div>
				<div class="6u 12u$(mobile)"><input type="number" name="rg" placeholder="Identidade" /></div>
				...
				<div class="6u$ 12u$(mobile)"><input type="text" name="vencimento" placeholder="Data de Vencimento" /></div>
				...
				<div class="6u 12u$(mobile)"><label>Data de Nascimento</label></div>
				<div class="6u$ 12u$(mobile)"><label>Data de Cadastro</label></div>
				<div class="6u 12u$(mobile)"><input type="date" name="date_nascimento"/></div>
				<div class="6u$ 12u$(mobile)"><input type="date" name="date_cadastro"/></div>
				<div class="12u$">
