...
<html>
<head>
<title>SGP - Cadastrar Financeiro</title>
<meta charset="utf-8" />
...
<body>
	...
	<div id="main">
		<section id="top" class="two">
			<div class="container">
				<br><br><br><br>
				<h3>Financeiro Cadastrado com Sucesso!</h3>
				<a href="Financeiro.jsp"><button type="button" class="btn btn-primary" data-dismiss="modal">Continuar</button></a>
				<br><br><br><br><br><br>
			</div>
		</section>
	</div>
