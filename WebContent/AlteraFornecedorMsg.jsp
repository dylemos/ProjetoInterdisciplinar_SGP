...
<html>
<head>
<title>SGP - Alterar Fornecedor</title>
<meta charset="utf-8" />
...
<body>
	...
	<div id="main">
		<section id="top" class="two">
			<div class="container">
				<br><br><br><br>
				<h3>Fornecedor Alterado com Sucesso!</h3>
				<a href="Fornecedor.jsp"><button type="button" class="btn btn-primary" data-dismiss="modal">Continuar</button></a>
				<br><br><br><br><br><br>
			</div>
		</section>
	</div>
