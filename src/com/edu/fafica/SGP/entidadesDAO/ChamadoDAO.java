...
public class ChamadoDAO {
	...
	public void cadastrarChamadoNoBancoDeDados(Chamado chamado) throws ClassNotFoundException, ChamadoJaCadastradoException, ChamadoIdInvalidoException, Exception{
		...
		try {
			...
			query += "values('"+chamado.getId()+"','"+chamado.getIdCliente()+"', '"+chamado.getTipoChamado()+"', '"+chamado.getDescProblema()+"', '"+chamado.getStatusChamado()+"', '"+chamado.getDataAbertura()+"', '"+chamado.getDataFechamento()+"')";
